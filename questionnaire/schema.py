...
class QuestionnaireRun(EntityType):
    ...
    instance_of = SubjectRelation('Questionnaire', cardinality='1*', inlined=True, composite='object')
...
class Question(EntityType):
    ...
    questionnaire = SubjectRelation('Questionnaire', cardinality='1*', inlined=True, composite='object')
...
class Answer(EntityType):
    ...
    questionnaire_run = SubjectRelation('QuestionnaireRun', cardinality='1*', inlined=True, composite='object')
